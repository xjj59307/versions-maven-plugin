...
/**
 * Sets a property to a wished version. Please be careful this can lead to changes which might not build anymore. The
 * sanity checks are done by other goals like <<<update-properties>>> etc. they are not done here. So use this goal with
 * care.
 *
